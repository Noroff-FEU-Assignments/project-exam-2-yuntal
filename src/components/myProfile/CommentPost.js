...
class Comment extends Component {
    ...
    submitHandler = e => {
        ...
        axios.get('https://api.noroff.dev/api/v1/social/posts/5208/comment', this.state, options)
        .then(response=>{
  ...
  submitHandler = e => {
      e.preventDefault()
      console.log(this.state, options)
      axios.post('https://api.noroff.dev/api/v1/social/posts/5208/comment', this.state, options)
      .then(response=>{
        console.log(response)
      })
      .then(response =>{
