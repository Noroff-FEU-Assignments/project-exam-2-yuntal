...
class FollowBatman extends Component {
    constructor(props) {
      super(props)
  ...
  submitHandler = e => {
      e.preventDefault()
      console.log(this.state, options)
      axios.put(`https://api.noroff.dev/api/v1/social/profiles/BruceWayne/follow`, this.state, options)
      .then(response=>{
        console.log(response)
      })
      .then(response =>{
